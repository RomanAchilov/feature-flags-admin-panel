...
function TableDemo() {
	...
	React.useEffect(() => {
		const columnFiltersFirstId = table.getState().columnFilters[0]?.id;
		const sortingFirstId = table.getState().sorting[0]?.id;
		if (columnFiltersFirstId === "fullName" && sortingFirstId !== "fullName") {
